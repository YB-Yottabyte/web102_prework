...
// use filter to count the number of unfunded games (games that have pledged less than their goal)
const unfundedGames = GAMES_JSON.filter(game => game.pledged < game.goal);
...
// Event listener to the search bar
searchBar.addEventListener("input", (event) => {
    ...
    // Clear and re-add games to the page based on the search result
    deleteChildElements(gamesContainer);
...
// Check if the user has previously selected dark mode using localStorage
